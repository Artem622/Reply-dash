  ...
  <div class="container container-fluid animate__animated animate__fadeIn">
    <div class="container-fluid">
      ...
      <div class="mb-3 input-area">
        <label for="exampleInputPassword1" class="form-label">Имя компании</label>
        <input type="password" class="form-control password animate__animated animate__shakeX" id="exampleInputPassword1" placeholder="Введите пароль...">
      </div>
      <router-link to="home" class="btn btn-primary">Войти</router-link>
      <div class="logo-box">
